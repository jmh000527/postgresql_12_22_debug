...
DECLARE_UNIQUE_INDEX(pg_outline_oid_index, 6200, on pg_outline using btree(oid oid_ops));
#define OutlineOidIndexId  6200
DECLARE_UNIQUE_INDEX(pg_outline_name_nsp_index, 6201, on pg_outline using btree(outlinename name_ops, outlinenamespace oid_ops));
#define OutlineNameNspIndexId  6201
